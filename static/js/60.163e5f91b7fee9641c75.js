...
var es = __webpack_require__(6753);
...
var placements = __webpack_require__(636);
...
var Dropdown = function Dropdown(props) {
  ...
  var getPlacement = function getPlacement() {
    ...
    if (placement.includes('Center')) {
      ...
      (0,devWarning/* default */.Z)(!placement.includes('Center'), 'Dropdown', "You are using '".concat(placement, "' placement in Dropdown, which is deprecated. Try to use '").concat(newPlacement, "' instead."));
      return newPlacement;
    }
...
function InternalMenu(props) {
  ...
  var customizePrefixCls = props.prefixCls,
      ...
      restProps = menu_rest(props, ["prefixCls", "className", "theme", "expandIcon", "_internalDisableMenuItemTitleTooltip", "inlineCollapsed", "siderCollapsed"]);

  var passedProps = (0,omit/* default */.Z)(restProps, ['collapsedWidth']); // ======================== Warning ==========================
  ...
  (0,devWarning/* default */.Z)(!(props.siderCollapsed !== undefined && 'inlineCollapsed' in props), 'Menu', '`inlineCollapsed` not control Menu under Sider. Should set `collapsed` on Sider instead.'); // ======================== Collapsed ========================
  // Inline Collapsed
  ...
  var prefixCls = getPrefixCls('menu', customizePrefixCls);
  var menuClassName = classnames_default()("".concat(prefixCls, "-").concat(theme), className); // ======================== Context ==========================
  ...
  (0,createClass/* default */.Z)(Menu, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react.createElement(Sider/* SiderContext.Consumer */.D.Consumer, null, function (context) {
        return /*#__PURE__*/react.createElement(InternalMenu, (0,esm_extends/* default */.Z)({}, _this.props, context));
      });
    }
  }]);
...
// EXTERNAL MODULE: ./node_modules/rc-dropdown/es/index.js + 3 modules
var rc_dropdown_es = __webpack_require__(6753);
...
function Dropdown(props, ref) {
  ...
  var getMenuElement = function getMenuElement() {
    ...
    var extraOverlayProps = {
      ...
      onClick: onClick,
      ref: (0,es_ref/* supportRef */.Yr)(overlayElement) ? menuRef : undefined
    };
...
var Menu = /*#__PURE__*/react.forwardRef(function (props, ref) {
  ...
  var mergedRef = (0,es_ref/* composeRef */.sQ)(containerRef, ref);
  var uuid = useUUID(id);
...
//# sourceMappingURL=60.163e5f91b7fee9641c75.js.map